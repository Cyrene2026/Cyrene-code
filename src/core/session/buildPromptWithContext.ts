...
const PROMPT_RECENT_TAIL_LIMIT = 10;
const PROMPT_RECENT_TEXT_LIMIT = 400;
const PROMPT_QUERY_CHAR_LIMIT = 20000;
const PROMPT_EXTENSION_CHAR_LIMIT = 10000;
const PROMPT_PLAN_LINE_LIMIT = 16;
const PROMPT_PLAN_TEXT_LIMIT = 360;
const PROMPT_WORKING_STATE_CHAR_LIMIT = 18000;
const PROMPT_PENDING_DIGEST_CHAR_LIMIT = 10000;
const PROMPT_FALLBACK_CHAR_LIMIT = 6000;
const PROMPT_WORKING_STATE_LINE_LIMIT = 320;
